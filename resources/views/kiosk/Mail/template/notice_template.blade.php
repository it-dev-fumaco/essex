...
<div class="col-md-12">
    <div class="row">
        ...
        <br>
        <a href="https://10.0.0.5/notice_slip/updateStatus{{ $params }}&approved=1" class="btn btn-success">Approve</a>
        <a href="https://10.0.0.5/notice_slip/updateStatus{{ $params }}" class="btn btn-danger">Disapprove</a>
        <br>
        <hr>
