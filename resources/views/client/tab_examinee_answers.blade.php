            ...
            <div class="col-md-12" style="padding: 2% 5% 1% 5%;">
               <table class="table table-striped" style="font-size: 11pt;">
                  ...
                  <tbody class="table-body">
                     ...
                     <tr>
                        <td style="text-align: center;">{{ $ans->q_no == "0" ? $i + 1 : $ans->q_no }}</td>
                        <td>{!! $ans->questions !!}
                           @if($ans->question_img) 
                        ...
                        <td class="center" style={{ strtoupper($ans->isCorrect) == 'TRUE' ? "color:#28B463;" : "color:#C0392B;" }}>{{ $ans->correct_answer}}</td>
                        @if(strtoupper($ans->isCorrect) == 'TRUE')
