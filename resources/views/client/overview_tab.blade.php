<div class="col-sm-7">
    <div class="d-flex flex-row pt-3">
        <div class="p-2 text-center col-4 d-grid gap-2">
            <button type="button" class="btn btn-secondary px-3 py-2" data-bs-toggle="modal" data-bs-target="#absentNoticeModal" id="notice-modal">
                <i class="fas fa-calendar-check fs-3 d-block m-2"></i>
                Absent Notice
            </button>
        </div>
        <div class="p-2 text-center col-4 d-grid gap-2">
            <button type="button" class="btn btn-success px-3 py-2" data-bs-toggle="modal" data-bs-target="#gatepassModal" id="gatepass-modal">
                <i class="fas fa-clipboard-list fs-3 d-block m-2"></i>
                Gatepass
            </button>
        </div>
        <div class="p-2 text-center col-4 d-grid gap-2" data-bs-toggle="modal" data-bs-target="#evaluationModal" id="evaluation-modal">
            <button type="button" class="btn btn-info px-3 py-2">
                <i class="fas fa-chart-bar fs-3 d-block m-2"></i>
                KPI Data Entry
            </button>
        </div>       
    </div>
...
<div class="col-sm-5">
    ...
    {{-- <div class="inner-box featured">
        <div class="widget property-agent">
            <h3 class="widget-title" style="font-size: 12px !important;">Calendar</h3>
            <div class="agent-info">
                <div class="calendar calendar-first" id="calendar_first">
                    <div class="calendar_header">
                        <button class="switch-month switch-left text-success"> <i class="icon-arrow-left"></i></button>
                        <a href="/calendar">
                            <h2></h2>
                        </a>
                        <button class="switch-month switch-right text-success"> <i class="icon-arrow-right"></i></button>
                    </div>
