<div class="modal fade" id="view-itemlist-{{ $row->id }}">
            ...
            <input type="hidden" name="id" value="{{ $row->id }}">
               <div class="row" style="margin: 7px;padding-top:0;padding-bottom: 0;">
                  ...
                  <div class="col-sm-6" style="float: right;">
                     ...
                     <input name="updatestat" id="updatestat" style="width: 100px;border: 0px none;" value="{{ $row->status }}" readonly>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                     <label style="width: 21%;">Category:</label>
                           ...
                           <input type="text" id="updatecategory" class="updatecategory" name="updatecategory" value="{{ $row->category}}" style="width: 150px;border: 0px none;" placeholder="updatecategory" readonly>
                           <br>
                           <label style="width: 21%;">Item Code:</label>
   
                                
                           <input type="text" id="updateitemcode" class="updateitemcode" name="updateitemcode" style="width: 150px;border: 0px none;" value="{{ $row->item_code}}" placeholder="updateitemcode" readonly>      
                     </div>
                  </div>
                  <h5>Item Details</h5>
                  <hr>
                  <div class="col-sm-12">
                     ...
                     <div class="col-sm-3" style="line-height: 25px;">
                        ...
                        <input type="text" value="{{ $row->qty}}" id="updateqty" name="updateqty" style="width: 80px;border: 0px none;" placeholder="Qty" readonly>
                     </div>
                  ...
                  <div class="col-sm-6">
                     ...
                     <div class="@if($row->brand == '') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Brand:</label>
                        <input type="text" value="{{ $row->brand}}" id="updatebrand" name="updatebrand" style="width: 150px;border: 0px none;" placeholder="Brand" readonly>
                     </div>
                     
                     <div style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Model:</label>
                        <input type="text" value="{{ $row->model }}" id="updatemodel" name="updatemodel" style="width: 150px;border: 0px none;" placeholder="Model" readonly>
                     </div>
                     <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Color:</label>
                        <input type="text" value="{{ $row->color }}" id="updatecolor" name="updatecolor" style="width: 150px;border: 0px none;" placeholder="Color" readonly>
                     </div>

                     <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Engine no.:</label>
                        <input type="text" value="{{ $row->engine }}" id="updateengine" name="updateengine" style="width: 150px;border: 0px none;" placeholder="Engine No." readonly>
                     </div>
                     <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Chasis no.:</label>
                        <input type="text" value="{{ $row->chasis }}" id="updatechasis" name="updatechasis" style="width: 150px;border: 0px none;" placeholder="Chasis No." readonly>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="@if($row->class == 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Mc Address:</label>
                        <input type="text" class="@if($row->mcaddress == '') disableme @endif" value="{{ $row->mcaddress }}" id="updatemcaddress" name="updatemcaddress" style="width: 150px;border: 0px none;" placeholder="Mc Address" readonly>
                     </div>
                     <div class="@if($row->class == 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Serial No:</label>
                        <input type="text" value="{{ $row->serial_no }}" id="updateserial_no" name="updateserial_no" style="width: 150px;border: 0px none;" placeholder="Serial No" readonly>
                     </div>
                      
                      <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Plate No:</label>
                        <input type="text" value="{{ $row->plate_no }}" id="updateplate" name="updateplate" style="width: 150px;border: 0px none;" placeholder="Plate No." readonly>
                     </div>
                     <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">Driver License No.:</label>
                        <input type="text" value="{{ $row->driver_license }}" id="updatedln" name="updatedln" style="width: 150px;border: 0px none;" placeholder="Driver License No." readonly>
                     </div>
                     <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">DL Type:</label>
                        <input type="text" value="{{ $row->dl_type }}" id="updatedl_type" name="updatedl_type" style="width: 150px;border: 0px none;" placeholder="DL Type" readonly>
                     </div>
                     <div class="@if($row->class != 'Car') hideme @endif" style="line-height: 25px;">
                        <label style="width: 44%;line-height: 35px;">RC No.:</label>
                        <input type="text" value="{{ $row->rc_no }}" id="updaterc_no" name="updaterc_no" style="width: 150px;border: 0px none;" placeholder="RC No." readonly>
                     </div>
                  </div>
