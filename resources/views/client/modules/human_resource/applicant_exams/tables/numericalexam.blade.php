<table class="table table-striped">
   ...
   <tbody class="table-body">
      ...
      @include('client.modules.human_resource.applicant_exams.modals.delete_numericalexam')
      @include('client.modules.human_resource.applicant_exams.modals.edit_numericalexam')
      @empty
      <tr>
