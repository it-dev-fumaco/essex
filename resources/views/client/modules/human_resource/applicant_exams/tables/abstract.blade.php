<table class="table">
   ...
   <tbody class="table-body">
      ...
      @include('client.modules.human_resource.applicant_exams.modals.delete_abstract')
      @include('client.modules.human_resource.applicant_exams.modals.edit_abstract')
      @empty
      <tr>
