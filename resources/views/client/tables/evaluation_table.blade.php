  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-center" style="width: 15%;">
        <a href="{{ Illuminate\Support\Facades\Storage::disk(config('filesystems.default'))->url('uploads/evaluations/'.$eval_files->evaluation_file) }}" target="_blank"><i class="fa fa-search"></i></a>
