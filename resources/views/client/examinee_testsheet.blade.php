...
<html lang="en">
   ...
   <body>
      ...
      <div class="header">
               <div class="col-md-12">
               <center><span class="section-title center">Examination Sheet</span><br><span style="font-size: 15pt; color: red;">DEVELOPMENT <br>& TESTING SITE</span></center>
                 
                        <div style="width: 40%;float: right;margin-top: -40px; margin-right: -150px;">
                                 <div class="alert alert-warning" style="font-size: 9pt; text-align: justify; display: inline-block; width: 60%;vertical-align: middle; border: 1px solid; margin: 0; line-height: 15px;z-index: 1;">
               ...
               <form method="POST" action="{{route('client.save_exam')}}" id="formSaveExam" autocomplete="off">
                  @csrf
                  ...
                  <div class="row" style="font-size: 11pt;">
                     <div class="col-md-12">
                        <table style="width: 70%;margin-top: -10%;">
                           <tr>
                              <td style="width: 40%;line-height: 15px;">
                                 <span class="h4" style="display: block;">Name: {{$examinee->employee_name}}</span>
                                 <span>Examination Title: {{$examinee->exam_title}}</span>
                                 <span style="display: block;">Today is: {{ date('l, F d, Y') }}</span>
                                 <span style="display: block;">Start Time: <span id="startTimeDisp"></span>
                              </td>
                              <td style="width: 23%;">
                                 <span class="h5">Duration <br><span id="duration" class="h3" style="color: darkgreen"></span></span></td>
