...
<html lang="en">
   ...
   <body>
                        ...
                        <div style="margin-top: 2%; font-size: 10pt;" class="col-md-12 tabbable">
                           ...
                           <div class="tab-content">
                              ...
                              <div class="tab-pane {{ $data['type_id'] == $current_tab ? 'active' : '' }}" id="tab{{ $data['type_id'] }}">
                                 ...
                                 <hr>
                                 <div id="msform">
                                    @include('online_exam.employee.questions')
                                 </div>
                              </div>
                              @endforeach
                              @endif
      ...
      @include('online_exam.employee.exam_details')
      ...
      $(document).ready(function(){
         ...
         $('#start-exam-btn').click(function(){
            ...
            $.ajax({
               url:"/oem/employee/update_examinee_status",
               method:"POST",
         ...
         function syncExamTimers(){
            ...
            if (remaining <= 0) {
               ...
               $('.update_time-remaining').val('00:00');
               if (!examEnded) {
                  examEnded = true;
            ...
            if (examStartedAt) {
               ...
               $('.update_time-spent').val(spentM + ':' + spentS);
            }
         }
      ...
      <script type="text/javascript">
         function preview_answer(){
            ...
            $.ajax({
               url:"/oem/employee/preview_examinee_answer" ,
               method:"GET",
               data: data,
               success:function(data){
      ...
      <script type="text/javascript">
         function save_form(){
            ...
            $.ajax({
               url:"/oem/employee/save_exam_result/"+ examineeId,
               method:"get",
               data: data,
               success:function(data){
                  window.location.replace("/oem/employee/examSubmitted/"+ examineeId);
               },
               error: function(data){
                  alert('Error saving');
               }
      ...
      <script type="text/javascript">
         $(document).on('click', '.update_no_answer', function(event){
            ...
            // $('#update_no_answer .update_examineeID').val($(this).data('id'));
            // $('#update_no_answer .update_questions_no').val($(this).data('question'));
            // $('#update_no_answer .update_exam').val($(this).data('exam'));
            // $('#update_no_answer .update_exam_type').val($(this).data('examtype'));
            data= {
            ...
            $.ajax({
               url:"/oem/employee/update_no_answer/" + examinee_id,
               method:"get",
               data: data,
               success:function(data){
