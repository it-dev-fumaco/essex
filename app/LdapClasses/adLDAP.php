...
use App\LdapClasses\Classes\adLDAPComputers;
use App\LdapClasses\Classes\adLDAPContacts;
use App\LdapClasses\Classes\adLDAPExchange;
use App\LdapClasses\Classes\adLDAPFolders;
use App\LdapClasses\Classes\adLDAPGroups;
use App\LdapClasses\Classes\adLDAPUsers;
use App\LdapClasses\Classes\adLDAPUtils;
use Exception;
...
class adLDAP
{
     ...
     * @var string
     */
    protected $accountSuffix = '@fumaco.local';
     ...
     * @var string
     */
    protected $baseDn = 'DC=fumaco,DC=local';
     ...
     * @var array
     */
    protected $domainControllers = ['10.0.0.10', '10.0.48.10'];
    ...
    {
        mt_srand(floatval(microtime()) * 100000000); // For older PHP versions
