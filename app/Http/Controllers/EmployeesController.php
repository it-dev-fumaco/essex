        ...
        try {
            ...
            if ($request->status == 'Resigned') {
                ...
                $log = [
                    ...
                    'recipient' => implode(', ', config('mail.it_recipients', ['dl.it@fumaco.com'])),
    ...
    public function employeeUpdate(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->status == 'Resigned') {
                ...
                // Keep resigned notice email even on update/edit.
                try {
                    $mail = $this->send_mail($log['subject'], $log['template'], config('mail.it_recipients', ['dl.it@fumaco.com']), $data, $log);
                } catch (\Throwable $th) {
                }
            } else {
                $employee->resignation_date = null;
